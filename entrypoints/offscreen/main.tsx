...
import { offscreenToBackgroundClient } from "@/lib/trpc/clients";
import { createTRPCMessageHandler } from "@/lib/trpc/crhome-adapter";
import { offscreenRouter } from "@/lib/trpc/offscreen-router";
...
setInterval(
	async () => {
		try {
			const result =
				await offscreenToBackgroundClient._internal.keepalive.mutate();
			console.log("[Offscreen] Alarm was recreated during health check",result);
		} catch (error) {
